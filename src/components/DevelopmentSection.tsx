...
const cards = [
  {
    ...
    button: { text: "Learn More About Web Development" },
  ...
  },
  {
    ...
    color: "bg-white/90 border border-neutral-200",
    button: { text: "Discover App Development" },
  ...
  },
  {
    ...
    color: "bg-white/90 border border-neutral-200",
    button: { text: "Explore Graphics Design" },
    ...
    <section className="py-16 bg-gradient-to-br from-green-50 via-white to-green-100">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-heading text-4xl sm:text-5xl font-bold text-primary-dark mb-4 drop-shadow">Development</h2>
