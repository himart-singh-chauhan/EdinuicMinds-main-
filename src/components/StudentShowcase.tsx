...
const StudentShowcase: React.FC = () => {
  ...
  image: 'https://gvu57hqxi3.ufs.sh/f/FOd38ztMu1UwxVCnwae4Fz9vfNj7L5miX4SuQMexJhoPwrag',
  ...
  image: 'https://gvu57hqxi3.ufs.sh/f/FOd38ztMu1Uw9PxrKivgnO69h0GCWXZDqcsxfQLUul1HaPRV',
    ...
    },
    {
      ...
      grade: 'Grade A',
      subject: 'Psychology',
  image: 'https://gvu57hqxi3.ufs.sh/f/FOd38ztMu1UwNOlJWB0yoU2FaRhrYmBI0dQZTqL1vMlnXJei',
    ...
    },
    {
      ...
      grade: 'Grade A+',
      subject: 'Finance',
  image: 'https://gvu57hqxi3.ufs.sh/f/FOd38ztMu1UwqU0Fak6WTuEra5gpLyiNsO2BSQ1G3lX0Dqe7',
  ...
  image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=400&q=80&fm=webp',
    ...
    },
    {
      ...
      grade: 'Grade A+',
      subject: 'Marketing',
  image: 'https://gvu57hqxi3.ufs.sh/f/FOd38ztMu1Uw89r0pF2dnNsVwYUm4zT2jLOIR5btMhSZuP6J',
