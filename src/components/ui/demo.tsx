...
const HeroDemo = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#0B1426] via-[#1A2B3D] to-[#0D1B2A] text-white flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl space-y-12 relative z-10 pt-8">
        
        {/* Main Content */}
        <div className="flex flex-col items-center text-center space-y-8">
          
          {/* Badge */}
          <Badge variant="outline" className="backdrop-blur-sm bg-[#2CA6A4]/20 border-[#2CA6A4]/50 text-[#2CA6A4] hover:bg-[#2CA6A4]/30 px-6 py-2 rounded-full text-sm font-medium mt-8">
