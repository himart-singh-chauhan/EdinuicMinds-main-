              ...
              >
                {images.map((image, index) => (
                  <SwiperSlide key={index}>
                    <div className="size-full rounded-3xl flex flex-col items-center justify-center bg-white/80 p-4">
                      <img
                        src={image.src}
                        width={220}
                        height={220}
                        ...
                        alt={image.alt}
                      />
                      <div className="mt-2 text-center text-black font-semibold">{image.alt}</div>
                    </div>
                  </SwiperSlide>
                ))}
              </Swiper>
